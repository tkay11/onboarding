...
class PollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post polls_url, params: { poll: { created_by: @poll.created_by, published: @poll.published, title: @poll.title } }
    end
  ...
  test "should update poll" do
    patch poll_url(@poll), params: { poll: { created_by: @poll.created_by, published: @poll.published, title: @poll.title } }
